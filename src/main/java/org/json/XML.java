                ...
                if (token instanceof String) {
                    ...
                    if (config.getForceList().contains(tagName)) {
                        ...
                        if (nilAttributeFound) {
                            ...
                            //avoids resetting the array in case of an empty tag in the middle or end
                            ...
                            if (string.length() > 0) {
                                if (xmlXsiTypeConverter != null) {
                                    ...
                                    if (obj instanceof Boolean) {
                                        ...
                                        jsonObject.accumulate(config.getcDataTagName(), config.isKeepStrings() ? ((String) token) : obj);
                                    } else {
